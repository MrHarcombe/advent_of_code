...
def run_through_sublists(cave_list, journey_length1, journey_length2):
    for me in combinations(cave_list, journey_length1):
        them = [cave for cave in cave_list if cave not in me]
...
for you, elephant in run_through_sublists(non_zero_caves, 8, 7):
