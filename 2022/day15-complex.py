...
start = time()
row = next((row for row in range(4000001) if len(check_row(sensors, row, 0, 4000000)) != 4000001))
candidate = check_row(sensors, row, 0, 4000000)
col = next((col for col in range(4000001) if complex(col, row) not in candidate))
print((col,row))
print("Time:", time() - start)
